...
export function showValidationError(message) {
  const modal = document.querySelector('#validationErrorModal');
  const messageEl = document.querySelector('#validationErrorMessage');
  ...
  // Bind close handlers
  const closeButtons = document.querySelectorAll('[data-validation-error-close]');
