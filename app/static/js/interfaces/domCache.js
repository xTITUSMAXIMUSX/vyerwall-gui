...
export function cacheElements() {
  ...
  elements.cancelAddInterfaceBtn = document.querySelector('#cancelAddInterfaceBtn');
  elements.addInterfaceCloseBtn = document.querySelector('#cancelAddInterface');
  ...
  elements.cancelCreateBtn = document.querySelector('#cancelCreateBtn');
  elements.createCloseBtn = document.querySelector('#cancelCreate');
  ...
  elements.cancelEditBtn = document.querySelector('#cancelEditBtn');
  elements.editCloseBtn = document.querySelector('#cancelEdit');
  ...
  elements.validationErrorModal = document.querySelector('#validationErrorModal');
  elements.validationErrorMessage = document.querySelector('#validationErrorMessage');
  elements.validationErrorCloseButtons = Array.from(document.querySelectorAll('[data-validation-error-close]'));
}
