...
class VyDevice:
    ...
    def config_file_save(self, file=None):
        ...
        Returns:
            ApiResponse: An ApiResponse object representing the API response.
        """
        return self._api_request(command="config-file", op='save', path=["dummy"], file=file, method="POST")
    ...
    def config_file_load(self, file=None):
        ...
        Returns:
            ApiResponse: An ApiResponse object representing the API response.
        """
        return self._api_request(command="config-file", op='load', path=["dummy"], file=file, method="POST")
